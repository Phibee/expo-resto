...
const TabBarButtonCustom = ({children, onPress, accessibilityState, style, ...props}) => {
  ...
  return (
    <TouchableOpacity
      {...props}
      style={accessibilityState?.selected ? [style, focusedContainerStyle] : style}
      onPress={e => {
        onPress(e);
      ...
      <Animated.View
        ...
        {accessibilityState?.selected ? (
          <LinearGradient
            ...
            style={
              accessibilityState?.selected
                ? [defaultButtonStyle, focusedButtonStyle]
                : defaultButtonStyle
            }>
            {children}
          </LinearGradient>
